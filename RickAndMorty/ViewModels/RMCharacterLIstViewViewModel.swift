...
final class  RMCharacterListViewViewModel: NSObject {
    ...
    public func fetchCharacters() {
        ...
        RMService.shared.execute(.listCharactersRequests, expecting: RMGetAllCharactersResponse.self) { [ weak self ] resultat in
            switch resultat {
...
extension RMCharacterListViewViewModel: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        guard kind == UICollectionView.elementKindSectionFooter,
              let footer = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: RMFooterLoadingCRV.idenfifier, for: indexPath) as? RMFooterLoadingCRV else {
            fatalError("Unsupported")
        }
        footer.startAnimating()
        return footer
    }
    //MARK: -> referenceSizeForFooterInSection
